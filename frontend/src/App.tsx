...
function App() {
  ...
  return <div className="app-shell"><a className="skip-link" href="#main-content">Перейти к содержимому</a>
    <header className="topbar">
      <div className="brand"><div className="brand-mark"><Compass size={23} strokeWidth={2.3} /></div><div><strong>Career Quest</strong><span>Навигатор карьерного развития</span></div></div>
